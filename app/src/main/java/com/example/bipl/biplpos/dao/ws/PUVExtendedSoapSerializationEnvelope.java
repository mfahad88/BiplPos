...
public class PUVExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    static HashMap< String,Class> classNames = new HashMap< String, Class>();
    static {
        classNames.put("http://ws.bi.com/^^wsParam",PUVwsParam.class);
        classNames.put("http://ws.bi.com/^^wsResponse",PUVwsResponse.class);
    }

    protected static final int QNAME_NAMESPACE = 0;
    private static final String TYPE_LABEL = "type";

    public PUVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public PUVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new PUVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            ...
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=String.class  )) {
                String xmlName=PUVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public Object get(Object soap,Class cl,boolean typeFromClass)
    {
        ...
        try
        {
            ...
            {
                Constructor ctor = cl.getConstructor(Object.class,PUVExtendedSoapSerializationEnvelope.class);
